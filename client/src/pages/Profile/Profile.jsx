...
function Profile() {
  ...
  const getFlightStatus = (departureDate, status) => {
    ...
    if (days > 0) return `Flight in ${days}d ${hours}h`;
    if (hours > 0) return `Flight in ${hours}h ${minutes}m`;
  ...
  if (loading) {
    return (
      <div className="profile-wrapper">
        <h2 className="profile-status">Loading profile...</h2>
      </div>
    );
  }
                ...
                return (
                  <div key={booking._id} className="booking-card">
                    ...
                    <p>
                      ...
                      >
                        {getFlightStatus(flight?.departureDate, booking.status)}
                      </span>
                    </p>
